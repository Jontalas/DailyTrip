...
const USER_AGENT=process.env.APP_USER_AGENT||"TravelPlannerPersonal/1.2.47 (personal-use)";
...
app.listen(PORT,()=>console.log(`Travel Planner 1.2.47 en http://localhost:${PORT}`));
